...
/*
//	duplication
    volatile _MMR xInput_dup;
    volatile _MMR xNPrimeofX_dup;
    volatile _MMR xK2_dup;
    volatile _MMR xK2_2_dup, xK2_3_dup, xK2_4_dup, xK2_5_dup;
    volatile _MMR xLocal_dup, xLocal_1_dup, xLocal_2_dup, xLocal_3_dup;
...
//    xK2_dup = _MM_ADD(xK2_dup, _MM_SET(1.0));
...
//    xLocal_dup   = _MM_MUL(xLocal_1_dup, xNPrimeofX_dup);
//    xLocal_tri   = _MM_MUL(xLocal_1_tri, xNPrimeofX_tri);
    xLocal   = _MM_SUB(_MM_SET(1.0), xLocal);
//    xLocal_dup   = _MM_SUB(_MM_SET(1.0), xLocal_dup);
...
// local private working variables for the calculation
    ...
    _MMR xLogTerm;
    _MMR xD1, xD2;
//    volatile _MMR xD1_dup, xD2_dup;
//    volatile _MMR xD1_tri, xD2_tri;
    _MMR err1, err2, err3, xD1_bak, xD2_bak;
    _MMR xPowerTerm;
//    volatile _MMR xPowerTerm_dup;
//    volatile _MMR xPowerTerm_tri;
    _MMR xDen;
//    volatile _MMR xDen_dup;
//    volatile _MMR xDen_tri;
...
//    xPowerTerm_dup = _MM_MUL(xVolatility, xVolatility);
//    xPowerTerm_tri = _MM_MUL(xVolatility, xVolatility);
    xPowerTerm = _MM_MUL(xPowerTerm, _MM_SET(0.5));
//    xPowerTerm_dup = _MM_MUL(xPowerTerm_dup, _MM_SET(0.5));
//    xPowerTerm_tri = _MM_MUL(xPowerTerm_tri, _MM_SET(0.5));
    xD1 = _MM_ADD(xRiskFreeRate, xPowerTerm);
//    xD1_dup = _MM_ADD(xRiskFreeRate, xPowerTerm_dup);
//    xD1_tri = _MM_ADD(xRiskFreeRate, xPowerTerm_tri);

    xD1 = _MM_MUL(xD1, xTime);
//    xD1_dup = _MM_MUL(xD1_dup, xTime);
//    xD1_tri = _MM_MUL(xD1_tri, xTime);

    xD1 = _MM_ADD(xD1, xLogTerm);
//    xD1_dup = _MM_ADD(xD1_dup, xLogTerm);
//    xD1_tri = _MM_ADD(xD1_tri, xLogTerm);
    xDen = _MM_MUL(xVolatility, xSqrtTime);
//    xDen_dup = _MM_MUL(xVolatility, xSqrtTime);
//    xDen_tri = _MM_MUL(xVolatility, xSqrtTime);
    xD1 = _MM_DIV(xD1, xDen);
//    xD1_dup = _MM_DIV(xD1_dup, xDen_dup);
//    xD1_tri = _MM_DIV(xD1_tri, xDen_tri);
    xD2 = _MM_SUB(xD1, xDen);
//    xD2_dup = _MM_SUB(xD1_dup, xDen_dup);
//    xD2_tri = _MM_SUB(xD1_tri, xDen_tri);

/*	err1 = _MM_CMPNEQ(xD1, xD1_dup);
	if ( _MM_MOVEMASK(err1) ){
		errors++;
		err2 = _MM_CMPNEQ(xD1, xD1_tri);
		if ( _MM_MOVEMASK(err2) ){
			errors++;
			err3 = _MM_CMPNEQ(xD1_dup, xD1_tri);
			if ( _MM_MOVEMASK(err3) )
				errors++;
			else
				xD1_bak = xD1_dup;
...
/*	err1 = _MM_CMPNEQ(xD2, xD2_dup);
	if ( _MM_MOVEMASK(err1) ){
		errors++;
		err2 = _MM_CMPNEQ(xD2, xD2_tri);
		if ( _MM_MOVEMASK(err2) ){
			errors++;
			err3 = _MM_CMPNEQ(xD2_dup, xD2_tri);
			if ( _MM_MOVEMASK(err3) )
				errors++;
			else
				xD2_bak = xD2_dup;
    ...
    _MM_STORE(d1, xD1_bak);
    _MM_STORE(d2, xD2_bak);
