...
#elif defined(SSE)
    smvp_sse(ARCHnodes, K, ARCHmatrixcol, ARCHmatrixindex, 
	       disp[dispt], disp[disptplus]);
#else
...
//      sum2 += A[Anext][2][0]*v[col][0] + A[Anext][2][1]*v[col][1] + A[Anext][2][2]*v[col][2];
          ...
          sum0_vec = _mm256_fmadd_pd(Anext0_vec, v_vec, sum0_vec);
          sum1_vec = _mm256_fmadd_pd(Anext1_vec, v_vec, sum1_vec);
          sum2_vec = _mm256_fmadd_pd(Anext2_vec, v_vec, sum2_vec);
...
//      w[col][2] += A[Anext][0][2]*v[i][0] + A[Anext][1][2]*v[i][1] + A[Anext][2][2]*v[i][2];
		  ...
		  av0_vec = _mm256_fmadd_pd(Anext0_vec, v0_vec, wcol_vec);
		  av1_vec = _mm256_fmadd_pd(Anext1_vec, v1_vec, av0_vec);
		  w_vec = _mm256_fmadd_pd(Anext2_vec, v2_vec, av1_vec);
